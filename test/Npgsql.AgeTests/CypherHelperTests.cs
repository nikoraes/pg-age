...
LIMIT 10";
        ...
        {
            string cypher =
                @"WITH '{""$dtId"":""523ecdd2-6f5d-4d60-9e77-11de6061583f"",""query"":""MATCH (current:Twin)-[*1..2]->(T:Twin) WHERE current[\'$dtId\']= \'@_selectedAssessementGroupId\' AND (digitaltwins.is_of_model(T,\'dtmi:com:konnektr:climaterisk:Asset;1\')) RETURN T.$dtId as Id, T.name as Name ORDER BY Name ASC""}'::agtype as twin
